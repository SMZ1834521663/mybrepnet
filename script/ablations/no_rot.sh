...
do
    ...
    nohup python train_net.py exp_name=zju_${SCENE}_rot rotate_gaussian=False subject=zju${SCENE} gpus=${GPU} ratio=0.5 resume=False > train_log/${SCENE}.log ratio=1 iterations=14000 &
done
