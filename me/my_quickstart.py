...
from me.my_extract_brepnet_data_from_step import extract_brepnet_data_from_step


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("--dataset_dir", type=str, required=False,help="Path to the folder you unzipped the segmentation dataset")
    parser.add_argument("--num_workers", type=int, default=1, help="Number ocondaf threads for processing")
    ...
    args = parser.parse_args(['--dataset_dir', '/data/public/smz24/fusion360_gallery/s2.0.1', '--num_workers', '1'])
    ...
    processed_dir = dataset_dir / "processed_me"
